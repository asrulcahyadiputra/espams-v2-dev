	...
	<div class="content">
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-8">
					<div class="card-box">
						<form method="POST" action="<?= site_url('master/pelanggan/update') ?>" class="needs-validation" novalidate>
							<div class="form-group row">
								<label for="id_golongan" class="col-sm-2 col-form-label">ID Pelanggan</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="id_pelanggan" id="id_pelanggan" value="<?= $pelanggan['id_pelanggan'] ?>" readonly>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="no_telp" id="no_telp" value="<?= $pelanggan['no_telp'] ?>" required>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<select name="id_golongan" id="id_golongan" class="form-control select2" required>
										...
										<?php foreach ($golongan as $g) : ?>
											<option <?= $pelanggan['id_golongan'] == $g['id_golongan'] ? 'selected' : '' ?> value="<?= $g['id_golongan'] ?>"><?= $g['nama_golongan'] ?></option>
										<?php endforeach ?>
									</select>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" name="meteran_awal" id="meteran_awal" min="0" value="<?= $pelanggan['meteran_awal'] ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="biaya_sr" class="col-sm-2 col-form-label">Biaya Pemasangan Baru </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="biaya_sr" id="biaya_sr" value="<?= nominal($trx['total']) ?>" data-type="currency">
								</div>
							</div>
							<div class="form-group row">
								<label for="tunggakan" class="col-sm-2 col-form-label">Tunggakan </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="tunggakan" id="tunggakan" value="<?= nominal($pelanggan['tunggakan']) ?>" data-type="currency">
								</div>
							</div>
							<div class="form-group row">
								<label for="denda" class="col-sm-2 col-form-label">Denda </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="denda" id="denda" value="<?= nominal($pelanggan['denda']) ?>" data-type="currency">
								</div>
							</div>
							<div class="form-group row">
								<label for="biaya_beban" class="col-sm-2 col-form-label">Alamat</label>
								<div class="col-sm-10">
									<textarea name="alamat" id="alamat" cols="30" rows="3" class="form-control" required><?= $pelanggan['alamat'] ?></textarea>
								</div>
							</div>
							<div class="form-group row">
