		...
		<div class="container">
			...
			<div class="container-fluid">
				<div class="row mb-3 mt-3 d-print-none">
					<div class="col-6">
						<form method="GET" action="<?= site_url('laporan/kas') ?>" class="form-inline">
					...
					<div class="col-6 text-right d-print-none">
						...
						<a href="<?= site_url('laporan/kas/export_excel/' . $year . '/' . $month) ?>" class="btn btn-lighten-success  btn-sm mb-2"><i class="mdi mdi-microsoft-excel"></i> Export Excel</a>
					</div>
				</div>
				<div class="row">
					<div class="col-12">
								...
								<table class="table table-sm table-bordered table-hover font-11">
									...
									<tbody>
										...
										<tr style="background-color: #ccff33;">
											<td class="text-left" colspan="6"><b>Saldo Akhir (Kas)</b></td>
											<td class="text-right">
